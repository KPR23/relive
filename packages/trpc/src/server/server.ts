...
const appRouter = t.router({
  ...
  folder: t.router({
    getRootFolder: publicProcedure.query(
      async () => 'PLACEHOLDER_DO_NOT_REMOVE' as any,
    ),
    getFolderChildren: publicProcedure.query(
      async () => 'PLACEHOLDER_DO_NOT_REMOVE' as any,
    ),
    createFolder: publicProcedure.mutation(
      async () => 'PLACEHOLDER_DO_NOT_REMOVE' as any,
    ),
    moveFolder: publicProcedure.mutation(
      async () => 'PLACEHOLDER_DO_NOT_REMOVE' as any,
    ),
    deleteFolder: publicProcedure.mutation(
      async () => 'PLACEHOLDER_DO_NOT_REMOVE' as any,
    ),
  }),
});
